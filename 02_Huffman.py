...
"""
 the time complexity of Huffman Encoding is Huffman Encoding is a lossless compression algorithm that 
 assigns shorter codes to more frequent characters to minimize data size. 
 The program:
